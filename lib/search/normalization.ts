...
export function normalizeAmazonRaw(raw: AmazonRawProduct): RawProviderListing | null {
  ...
  return {
    ...
    condition: classifyListingCondition(raw.title),
    rating: raw.rating ?? 0,
...
export function normalizeOxylabsAmazonSearchResults(
  ...
  for (const item of raw) {
    ...
    listings.push({
      ...
      storeName,
      category: "General",
      condition: classifyListingCondition(item.title),
...
export function normalizeAmazonScraperRaw(
  ...
  return {
    ...
    storeName,
    category: raw.category?.trim() || "General",
    condition: classifyListingCondition(raw.title.trim()),
    rating: raw.rating ?? 0,
    reviewCount: raw.reviewCount ?? 0,
...
export function normalizeEbayRaw(raw: EbayRawProduct): RawProviderListing | null {
  ...
  return {
    ...
    condition: classifyListingCondition(raw.title, raw.condition),
    rating: 0,
    reviewCount: 0,
    inStock,
    productUrl,
...
export function normalizeCJRaw(raw: CJRawProduct): RawProviderListing | null {
  ...
  return {
    ...
    condition: classifyListingCondition(title),
    rating: 0,
    reviewCount: 0,
    inStock: true,
    productUrl,
...
export function normalizeAdmitadRaw(
  ...
  return {
    ...
    category: "General",
    condition: classifyListingCondition(offer.name),
    rating: 0,
    reviewCount: 0,
    inStock: true,
