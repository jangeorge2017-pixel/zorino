...
const HOMEPAGE_LOCALES = ["en", "ar"] as const;
...
function isHomepagePath(pathname: string): boolean {
  ...
  return (
    ...
    HOMEPAGE_LOCALES.includes(segments[0] as (typeof HOMEPAGE_LOCALES)[number])
...
function ZorinoHomeQuickNavContent() {
...
export default function ZorinoHomeQuickNav() {
  ...
  return <ZorinoHomeQuickNavContent />;
