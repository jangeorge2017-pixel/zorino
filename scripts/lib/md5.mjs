/**
 * RFC 1321 MD5 over UTF-8 bytes (plain-JS mirror of lib/integrations/aliexpress/md5.ts).
 *
 * The AliExpress/TOP OpenAPI mandates MD5 as the request signing algorithm
 * (sign_method: "md5" is validated server-side), so these one-off diagnostics
 * must produce MD5 digests. This pure-JS implementation is only ever used for
 * that mandated request signature — never for hashing secrets or integrity.
 */
...
export function md5HexUtf8(input) {
